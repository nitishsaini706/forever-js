...
function displaymenuButtons(){
    ...
    // const categories = menu.reduce((values,item) => {
    //     return ( !(values.includes(item.category)) ? values.push(item.category) : values)
    // },["all"]);
    ...
    button.forEach(function(btn){
        btn.addEventListener('click' , function(e){
            ...
            const m= menu.filter(function(menuItems)
            {
                if(category === menuItems.category) return menuItems;
